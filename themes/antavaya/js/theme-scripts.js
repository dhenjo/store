...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').datepicker({
        showOn: 'button',
        buttonImage: 'themes/antavaya/images/icon/blank.png',
        buttonText: '',
		...
		onSelect: function(date) {
				...
				tjq('#tglr').val(gt.getDate()+' '+month[gt.getMonth()]+' '+gt.getFullYear());
        },
	...
	tjq('.datepicker-wrapo input').datepicker({
        showOn: 'button',
        buttonImage: 'themes/antavaya/images/icon/blank.png',
        buttonText: '',
        buttonImageOnly: true,
        ...
        dayNamesMin: ["S", "M", "T", "W", "T", "F", "S"],
        beforeShow: function(input, inst) {
            var themeClass = tjq(input).parent().attr("class").replace("datepicker-wrapo", "");
            tjq('#ui-datepicker-div').attr("class", "");
            tjq('#ui-datepicker-div').addClass("ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all");
            tjq('#ui-datepicker-div').addClass(themeClass);
        }
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        var forchBottom;
        var chaser = tjq('#main-menu ul.menu').clone().hide().appendTo(document.body).wrap("<div class='chaser hidden-mobile'><div class='container' style='padding-top: 15px; padding-bottom: 15px;'></div></div>");
        tjq('<h1 class="navbar-brand"><a title="Antavaya Tour & Travel - Home " href="'+tjq('#link_home').text()+'"><img alt="" src="'+tjq('#link_themes').text()+'images/logo.png"></a></h1>').insertBefore('.chaser .menu');
