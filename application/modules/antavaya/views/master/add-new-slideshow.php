    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_website_slideshow))?>
              <div class="box-body">
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file)
                    print "<br /><img src='".base_url()."files/antavaya/slideshow/{$detail[0]->file}' width='100' />";
                  else
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("antavaya/master-antavaya/slideshow")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->