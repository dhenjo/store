    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_website_group_tour_book, "id_website_group_tour" => $detail[0]->id_website_group_tour))?>
              <div class="box-body">
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("grouptour/master-grouptour/book")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->