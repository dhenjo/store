...
<div class="row">
 ...
 <li><a href="#room_<?php echo $r; ?>" data-toggle="tab">Room  <?php echo $r; ?></a></li>
      <?php }} ?>
 <li><a href="#additional" data-toggle="tab">Information Additonal</a></li>
                  ...
                  foreach ($data->book->passenger as $valps) {
                   // echo $valps['status'];
                    if($valps->status == "Book"){
                      $nobook2 +=  $nobook + 1;
                    }elseif($valps->status == "Committed Book"){
               ...
               <?php
                foreach($data->book->additional AS $add){
                  print "<tr>"
                    ...
                    . "<td>".number_format($add->nominal_additional,0,",",".")."</td>"
                  . "</tr>";
                }
                ?>
            </table>      
       ...
       <td>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                   <li><a href="'.site_url("grouptour/product-tour/change-tour/".$data->book->code."/".$data->tour_info[$key]->code).'">Change</a></li>
            </ul>
          </div>
        </td>
      </tr>';
