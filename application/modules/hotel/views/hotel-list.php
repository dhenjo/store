                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                            ...
                            <div class="hotel-list listing-style3 hotel">
                                <?php
                                $r = "0";
                                foreach($data->hotel AS $dt){
                                ?>
                                <article class="box">
                                    <figure class="col-sm-5 col-md-4">
                                        <a title="" class="hover-effect popup-gallery"><img width="270" height="160" alt="" src="http://demo.hotelxml.com/inc/imageDisplay.asp?hCode=<?php print $dt->HCode->$r?>" onerror="javascript:this.src='<?php print base_url()?>files/no-pic.png';"></a>
                                    </figure>
                                    <div class="details col-sm-7 col-md-8">
                                        <div>
                                            <div>
                                                <h4 class="box-title"><a href="<?php print site_url("hotel/hotel-detail/".$dt->HCode->$r)?>">
                                                  <?php print $dt->Name->$r?>
                                                  </a>
                                                    <small><i class="soap-icon-departure yellow-color"></i> <?php print $dt->RmGrade->$r?></small></h4>
                                                <div class="amenities">
<!--                                                    <i class="soap-icon-wifi circle"></i>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <span class="price"><small>AVG/NIGHT</small>$<?php print number_format($dt->TotalRate->$r, 0,".",",")?></span>
                                                <a class="button btn-small full-width text-center" onclick="detail_hotel('<?php print $dt->HCode->$r?>')" title="" href="javascript:void(0)">SELECT</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="list_harga<?php print $dt->HCode->$r?>" style="display: none">
                                        <table width="100%" class="table">
                                            ...
                                            <tbody id="hasil_harga<?php print $dt->HCode->$r?>">
                                                <tr><td colspan="6"><img src="<?php print $url?>/images/ajax-loader.gif" id="id_loading_daftar<?php print $dt->HCode->$r?>" 
                                                                         class="loading_daftar_harga" /></td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </article>
