    ...
    foreach ($data_array->data AS $da){
      $hasil[] = array(
        ...
        . "<a class='tooltip-harga' isi='{$da->kode_info}' href='".site_url("grouptour/product-tour/book-tour/".$da->kode_info)."'>"
          . date("d M y", strtotime($da->start_date))
        . "</a>",
    ...
    foreach ($data_array->data AS $da){
      $hasil[] = array(
        ...
        "<div class='btn-group'>"
          ...
          . "<a href='".site_url("tour/tour-master/duplicate-schedule/{$da->id_tour_schedule}")."' type='button' class='btn btn-warning btn-flat' style='width: 40px'><i class='fa fa-calendar'></i></a>"
