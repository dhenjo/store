    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_website_promosi))?>
              <div class="box-body">
                ...
                <div class="control-group">
                  <label>Price</label>
                    <?php print $this->form_eksternal->form_input("price", $detail[0]->price, 'class="form-control" placeholder="Price"');?>
                </div>

                <div class="control-group">
                  <label>Status</label>
                    <?php print $this->form_eksternal->form_dropdown('status', array('1' => "Aktif", '2' => "Promo", '3' => 'Draft'), array($detail[0]->status), 'class="form-control input-sm"')?>
                </div>
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file)
                    print "<br /><img src='".base_url()."files/antavaya/promosi/{$detail[0]->file}' width='100' />";
                  else
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file_temp)
                    print "<br /><img src='".base_url()."files/antavaya/promosi/{$detail[0]->file_temp}' width='100' />";
                  else
                    print "<br /><img src='".base_url()."files/no-pic.png' width='50' />";
                  ?>
                </div>
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file_pdf)
                    print "<br /><a href='".base_url()."files/antavaya/promosi/{$detail[0]->file_pdf}' />{$detail[0]->file_pdf}</a>";
                  ?>
                </div>
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("antavaya/master-antavaya/promosi")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->