            ...
            <div id="main" class="col-sm-8 col-md-9">
                <div class="image-box style9 column-4">
                    ...
                    <article class="box" style="height: 300px">
                        ...
                        ?>
                        <figure>
                            <a href="<?php print site_url("fit/detail/{$dt->nicename}")?>" title="" class="hover-effect yellow">
                                <img src="<?php print base_url()."files/antavaya/fit/{$dt->file_temp}"?>" alt="" width="160" height="160" style="max-height: 160px" /></a>
                        </figure>
                        <?php
                        }
                        ?>
                        <div class="details">
                            ...
                            <a href="<?php print site_url("fit/detail/{$dt->nicename}")?>" title="" class="button">Detail</a>
                        </div>
                    </article>
                    <?php
                    }
