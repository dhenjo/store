<div class="page-title-container">
    <div class="container">
        ...
        <ul class="breadcrumbs pull-right">
            ...
            <li><a href="<?php print site_url('fit')?>">FIT & Packages</a></li>
                      ...
                      <div class="blog-infinite">
                          <div class="post">
                              <div class="post-content-wrapper">
                                  <div class="flexslider photo-gallery style4">
                                      <ul class="slides">
                                          <?php
                                        if($haji[0]->file){
                                          print "<li><a href='javascript:void(0)'><img src='".base_url()."files/antavaya/fit/{$haji[0]->file}' alt=''></a></li>";
                                        }
                                        if($gambar){
                                          foreach($gambar AS $gbr){
                                            print "<li><a href='javascript:void(0)'><img src='".base_url()."files/antavaya/fit/{$gbr->file}' alt=''></a></li>";
                                          }
                                        }
                                        ?>
                                      </ul>
                              ...
                              <div class="details" id="nbs">
                                <h3 style="text-align: center"><?php print $haji[0]->title?></h3>
                                <h4 style="text-align: center"><?php print $haji[0]->sub_title?></h4>
                                <?php 
                                print str_replace("<td", "<td valign='top'", $haji[0]->note);
...
//                                }
                                ...
                                <div id="dialog-form" title="Book Now">
                                  <form>
                                    <fieldset>
                                      ...
                                      <input type="text" value="<?php print $haji[0]->id_website_fit?>" name="id_website_fit" id="id_website_fit" style="display: none">
                                      <br />
                                      <br />
                                ...
                                <div class="row">
                                  <div class="col-md-6" style="text-align: left; font-size: 16px">
                                    <a target="_blank" class="button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" href="<?php print base_url()."files/antavaya/fit/{$haji[0]->file_pdf}"?>">Download Itinerary</a></div>
