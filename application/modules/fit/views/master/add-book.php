    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_website_fit_book, "id_website_fit" => $detail[0]->id_website_fit))?>
              <div class="box-body">
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("fit/master-fit/book")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->