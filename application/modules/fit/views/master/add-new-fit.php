    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_website_fit))?>
              <div class="box-body">
...
<!--                <div class="control-group">
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file)
                    print "<br /><img src='".base_url()."files/antavaya/fit/{$detail[0]->file}' width='100' />";
                  else
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file_temp)
                    print "<br /><img src='".base_url()."files/antavaya/fit/{$detail[0]->file_temp}' width='100' />";
                  else
                    print "<br /><img src='".base_url()."files/no-pic.png' width='50' />";
                  ?>
                </div>
                ...
                <div class="control-group">
                  ...
                  if($detail[0]->file_pdf)
                    print "<br /><a href='".base_url()."files/antavaya/fit/{$detail[0]->file_pdf}' />{$detail[0]->file_pdf}</a>";
                  ?>
                </div>
