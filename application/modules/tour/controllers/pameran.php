    ...
    if($pst){
      $foot .= "<script>"
        ...
        . "function ambil_data(table, start){"
          . "$.post('".site_url("tour/pameran-ajax/finance-report-get")."', {start: start, "
          . "nomor: $('#nomor').val(),"
          . "awal: '{$pst['awal']}',"
          . "akhir: '{$pst['akhir']}',"
...
//                . "$( rowNode ).attr('isi',hasil.banding[ind]);"
              ...
              . '}'
              . 'var cash = hasil.jumlah.cash * 1;'
              . 'var jml_cash = $("#cash").text() * 1;'
              . 'var total_cash = cash + jml_cash;'
              . '$("#cash").text(number_format(total_cash));'
            
              . 'var bca = hasil.jumlah.bca * 1;'
              . 'var jml_bca = $("#bca").text() * 1;'
              . 'var total_bca = bca + jml_bca;'
              . '$("#bca").text(number_format(total_bca));'
            
              . 'var mandiri = hasil.jumlah.mandiri * 1;'
              . 'var jml_mandiri = $("#mandiri").text() * 1;'
              . 'var total_mandiri = bca + jml_mandiri;'
              . '$("#mandiri").text(number_format(total_mandiri));'
            
              . 'var mega = hasil.jumlah.mega * 1;'
              . 'var jml_mega = $("#mega").text() * 1;'
              . 'var total_mega = mega + jml_mega;'
              . '$("#mega").text(number_format(total_mega));'
            
              . 'var ccmega = hasil.jumlah.ccmega * 1;'
              . 'var jml_ccmega = $("#ccmega").text() * 1;'
              . 'var total_ccmega = ccmega + jml_ccmega;'
              . '$("#ccmega").text(number_format(total_ccmega));'
            
              . 'var lainnya = hasil.jumlah.lainnya * 1;'
              . 'var jml_lainnya = $("#lainnya").text() * 1;'
              . 'var total_lainnya = lainnya + jml_lainnya;'
              . '$("#lainnya").text(number_format(total_lainnya));'
            
              . 'var debit = hasil.jumlah.debit * 1;'
              . 'var jml_debit = $("#debit").text() * 1;'
              . 'var total_debit = debit + jml_debit;'
              . '$("#debit").text(number_format(total_debit));'
    ...
    $this->template->build('pameran/finance-report', 
      array(
        'url'           => base_url()."themes/".DEFAULTTHEMES."/",
        'menu'          => "tour/pameran/finance-report",
        'data'          => $data_array->data,
