            ...
            <div class="box">
              <div class="box-body table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td><a href='<?php print site_url("tour/room-list-umum/{$data->tour->code_schedule}")?>'>Room List</a></td>
                    <td><a href='<?php print site_url("tour/list-tour-book-umum/{$data->tour->code_schedule}")?>'>Tour Book List</a></td>
