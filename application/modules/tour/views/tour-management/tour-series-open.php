            ...
            <div class="box">
              <div class="box-body table-responsive">
                <div class="row">
                    <div class="col-xs-6">
                      <?php
                      print $this->form_eksternal->form_input('awal', '','class="form-control input-sm tanggal" placeholder="Start Date"');
                      ?>
                    </div>
                    <div class="col-xs-6">
                      <?php
//                      print $this->form_eksternal->form_dropdown("akhir", $mulai2, array(), "class='form-control input-sm'");
                      print $this->form_eksternal->form_input('akhir', '','class="form-control input-sm tanggal" placeholder="Start Date"');
                      ?>
                    </div>
                </div>
                <div class="row">
