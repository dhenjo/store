            ...
            <div class="form-group">
              <div class="row">
                  <div class="col-xs-3">
                    ...
                    <br /><span><?php print $pameran->title?></span>
                  </div>
                  <div class="col-xs-3">
                    <label>Location</label>
                    <br /><span><?php print $pameran->location?></span>
                  </div>
                  <div class="col-xs-6">
                    <label>Schedule</label>
                    <br /><span><?php print date("d F Y", strtotime($pameran->date_start))?> - <?php print date("d F Y", strtotime($pameran->date_end))?></span>
                  </div>
                  <div class="col-xs-3">
