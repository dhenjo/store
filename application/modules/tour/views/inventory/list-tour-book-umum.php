            ...
            <div class="box">
              <div class="box-body table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td><a href='<?php print site_url("tour/tour-inventory/room-list-umum/{$id_inventory}/{$info->information->code}")?>'>Room List</a></td>
                    <td><a href='<?php print site_url("tour/tour-inventory/list-tour-book-umum/{$id_inventory}/{$info->information->code}")?>'>Tour Book List</a></td>
