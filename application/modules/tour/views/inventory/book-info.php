...
<?php print $this->form_eksternal->form_open("grouptour/product-tour/send-passenger", 'id=form2 role="form"', 
                    array(
                      ...
                      "id_payment"                      => $payment[0]->id_product_tour_book_payment,
                      "id_master_sub_agent"             => 1  
                    ))?>
...
<!--      <div class="control-group">
      ...
      <?php print $this->form_eksternal->form_input('ifirst_name', $data[0]->first_name, 'onblur="set_nama()" id="pemesan_depan" class="form-control input-sm" placeholder="Nama Depan"');?>
      </div>
      <div class="control-group">
      <label>Nama Belakang Pemesan</label>
      <?php print $this->form_eksternal->form_input('ilast_name', $data[0]->last_name, 'onblur="set_nama()" id="pemesan_belakang" class="form-control input-sm" placeholder="Nama Belakang"');?>
      </div>
      <div class="control-group">
      <label>Email</label>
      ...
      <div class="control-group">
      <label>No Telp</label>
      <?php print $this->form_eksternal->form_input('itelp', $data[0]->telp, 'onblur="set_nama()" class="form-control input-sm" id="no_telp_pemesan" placeholder="No Telp"');?>
      </div>
       <div class="control-group">
      <label>Alamat Pemesan</label>
      
      <?php print $this->form_eksternal->form_textarea('address', $data[0]->alamat, 'class="form-control input-sm" id="address_pemesan" placeholder="Address"');?>
      </div>     
          </div><!-- /.tab-pane -->
       <?php  
