        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="form-group">
              ...
              <div class="col-xs-3">
                <label>Status</label>
                <?php print $this->form_eksternal->form_dropdown('tour_status', array(NULL => "- Pilih -", 1 => "Active",3 => "Cancel", 4 => "Close"), array($this->session->userdata("tour_status")), 'class="form-control input-sm"');?>
              </div>
